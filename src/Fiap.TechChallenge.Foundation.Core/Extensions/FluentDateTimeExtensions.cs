...
public static class FluentDateTimeExtensions
{
        ...
        int microseconds = 0, int nanoseconds = 0)
    {
        ...
        if (microseconds != 0) value += microseconds.Microseconds();

        if (nanoseconds != 0) value += nanoseconds.Nanoseconds();
