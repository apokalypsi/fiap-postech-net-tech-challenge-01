...
public sealed class ContatoEntity : EntityBase<Guid>
{
    ...
    {
        Contract.Requires.IsNotNullOrWhiteSpace(nome, nameof(nome)).Guard();
        Nome = nome;
    }
    ...
    {
        Contract.Requires.IsNotNullOrWhiteSpace(telefone, nameof(telefone)).Guard();
        Telefone = telefone;
    }
    ...
    {
        Contract.Requires.IsNotNullOrWhiteSpace(email, nameof(email)).IsValidEmail(email, nameof(email)).Guard();
        Email = email;
    }
    ...
    {
        Contract.Requires.IsBetween(ddd, 11, 99, nameof(ddd)).Guard();
        DDD = ddd;
    }
}